...
for ax in [ax1,ax2,ax3,ax4]:
    ...
    ax.legend()
    ax.grid()
plt.suptitle('Ni=0 sin recubrir - 4ta repeticion',fontsize=14)
plt.savefig('tau_Ni0_D_sin_recubrir.png',dpi=300,facecolor='w')
...
plt.suptitle('Ciclos promedio - Ni=0 s/ recubrir', fontsize=14)
plt.savefig('ciclos_promedio_all_Ni0_sin_recubrir.png', dpi=300)
